    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarExample01">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="admin_coin.php" target="_blank">ADMIN</a>
          </li>
        </ul>
        ...
        <?php
         ...
         if(mysqli_num_rows($qry) <= 0){
           ...
           //   $og_data = mysqli_fetch_array($og, MYSQLI_BOTH);
             ...
             if($row['name'] ==  $session_username ){
               ?>
                <p><button type="submit" class='btn btn-sm btn-outline-danger' > <a class ="chapter" href="<?php echo $row['href'] ?>"><?php echo"ตอน " . $row['chapter']."    " ?><img src="unlock.png" width="25px"></a></button></P>
              ...
              ?>
               ...
               <form method="post" action="checkreadbluelock.php">                                                                 
                ...
                <p><button type="submit" class='btn btn-sm btn-outline-danger' > <a class ="chapter" ><?php echo"ตอน " . $row['chapter']."    ".$row['price']."coin "  ?><img src="unlock.png" width="25px"></a></button></P>
             </form>
               <?php
             }
           }
