...
<nav class="navbar navbar-expand-lg navbar-dark d-none d-lg-block" style="z-index: 2000;">
  ...
  <div class="btn-group" role="group">
    ...
    <?php
         ...
         <img src="readingbluelock2/1.jpg" class="rounded mx-auto d-block"  style= "margin-top: 8%"   width =" 700px" alt="...">
         <img src="readingbluelock2/2.jpg" class="rounded mx-auto d-block"    width =" 700px" alt="...">
         <img src="readingbluelock2/3.jpg" class="rounded mx-auto d-block"  width =" 700px" alt="...">
         <img src="readingbluelock2/4.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/5.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/6.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/7.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/8.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/9.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/10.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/11.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/12.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/13.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/14.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/15.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/16.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/17.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/18.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock2/19.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         </div>
