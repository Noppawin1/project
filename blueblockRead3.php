...
<nav class="navbar navbar-expand-lg navbar-dark d-none d-lg-block" style="z-index: 2000;">
  ...
  <div class="btn-group" role="group">
    ...
    <?php
         ...
         <img src="readingbluelock3/1.jpg" class="rounded mx-auto d-block"  style= "margin-top: 8%"   width =" 700px" alt="...">
         <img src="readingbluelock3/2.jpg" class="rounded mx-auto d-block"    width =" 700px" alt="...">
         <img src="readingbluelock3/3.jpg" class="rounded mx-auto d-block"  width =" 700px" alt="...">
         <img src="readingbluelock3/4.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/5.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/6.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/7.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/8.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/9.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/10.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/11.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/12.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/13.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/14.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/15.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/16.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/17.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/18.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/19.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/20.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/21.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/22.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/22.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/23.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingbluelock3/24.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         </div>
