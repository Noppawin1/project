...
<nav class="navbar navbar-expand-lg navbar-dark d-none d-lg-block" style="z-index: 2000;">
  ...
  <div class="btn-group" role="group">
    ...
    <?php
         ...
         <img src="readingovergeared2/1.jpg" class="rounded mx-auto d-block"  style ="margin-top:8%"  width =" 700px" alt="...">
         <img src="readingovergeared2/2.jpg" class="rounded mx-auto d-block"    width =" 700px" alt="...">
         <img src="readingovergeared2/3.jpg" class="rounded mx-auto d-block"    width =" 700px" alt="...">
         <img src="readingovergeared2/4.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared2/5.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared2/6.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared2/7.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared2/8.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared2/9.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared2/10.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared2/11.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         </div>
