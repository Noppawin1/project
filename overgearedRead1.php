...
<nav class="navbar navbar-expand-lg navbar-dark d-none d-lg-block" style="z-index: 2000;">
  ...
  <li>
         ...
         <h2 class="text-center" style ="color: white; margin-top:2%">Overgeared ตอนที่1</h2>
  ...
  <div class="btn-group" role="group">
    ...
    <?php
         ...
         <div class="text-bg-light p-3 rounded-5" style="margin-left:400px; margin-right:400px;">
         <img src="readingovergeared1/1.jpg" class="rounded mx-auto d-block"  style =" margin-top:8%"  width =" 700px" alt="...">
         <img src="readingovergeared1/2.jpg" class="rounded mx-auto d-block"    width =" 700px" alt="...">
         <img src="readingovergeared1/3.jpg" class="rounded mx-auto d-block"  width =" 700px" alt="...">
         <img src="readingovergeared1/4.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared1/5.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared1/6.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared1/7.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared1/8.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared1/9.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared1/10.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared1/11.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared1/12.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         </div>
