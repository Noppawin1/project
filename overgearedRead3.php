...
<nav class="navbar navbar-expand-lg navbar-dark d-none d-lg-block" style="z-index: 2000;">
  ...
  <li>
         ...
         <h2 class="text-center" style ="color: white; margin-top:2%">Overgeared ตอนที่3</h2>
  ...
  <div class="btn-group" role="group">
    ...
    <?php
         ...
         <img src="readingovergeared3/1.jpg" class="rounded mx-auto d-block"  style =" margin-top:8%" width =" 700px" alt="...">
         <img src="readingovergeared3/2.jpg" class="rounded mx-auto d-block"    width =" 700px" alt="...">
         <img src="readingovergeared3/3.jpg" class="rounded mx-auto d-block"    width =" 700px" alt="...">
         <img src="readingovergeared3/4.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared3/5.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared3/6.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared3/7.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared3/8.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared3/9.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared3/10.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         <img src="readingovergeared3/11.jpg" class="rounded mx-auto d-block"    width =" 700px"alt="...">
         </div>
