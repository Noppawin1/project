...
<html>
    <head>
        ...
        <link rel="stylesheet" href ="overgeared.css" >
...
<nav class="navbar navbar-expand-lg navbar-dark d-none d-lg-block" style="z-index: 2000;">
  ...
  <div class = "f">
    ...
    <a href="overgeared.php"><div class="module06 lr">
          <p class="front">Martial Peak</p>
        </div></a>
        <a href="nanomashin.php"><div class="module07 lr">
          <p class="front">Mercenary Enrollment</p>
        </div></a>
        <a href="bluelock.php"><div class="module08 lr">
          <p class="front">The Max Level Hero has Returned</p>
        </div></a>
        <a href="bluelock.php"><div class="module09 lr">
          <p class="front">Sleeping Ranker</p>
        </div></a>
        <a href="bluelock.php"><div class="module10 lr">
          <p class="front">Solo Max-Level Newbie</p>
        </div></a>
        <a href="bluelock.php"><div class="module11 lr">
          <p class="front">Swordmaster’s Youngest Son</p>
        </div></a>
        <a href="bluelock.php"><div class="module12 lr">
          <p class="front">Return of the Frozen Player</p>
        </div></a>
        <a href="bluelock.php"><div class="module13 lr">
          <p class="front">Chronicles of Heavenly Demon</p>
        </div></a>
        <a href="bluelock.php"><div class="module14 lr">
          <p class="front">Leveling With The Gods</p>
        </div></a>
        <a href="bluelock.php"><div class="module15 lr">
          <p class="front">Tomb Raider King</p>
        </div></a>
        <a href="bluelock.php"><div class="module16 lr">
          <p class="front">MookHyang Dark Lady</p>
        </div></a>
        <a href="bluelock.php"><div class="module17 lr">
          <p class="front">The Descent of the Demonic Master</p>
        </div></a>
         ...
         <center>
        <div class ="pag" style ="margin-top: 50%">
